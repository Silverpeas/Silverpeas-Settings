...
/**
 * Titre :        SilverpeasSettings
 * Description :  SilverpeasSettings permet de configurer les fichiers de Silverpeas
 * a partir de fichiers xml presents dans silverpeas/setup/settings
